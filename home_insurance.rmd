...
ranges <- c(1890, 1895, 1900, 1905, 1910, 1915, 1920, 1925, 1930, 1935, 1940, 1945, 1950, 1955, 1960, 1965, 1970, 1975, 1980, 1985, 1990)  # Add more ranges as needed
...
findInterval(dataset$year, ranges) + 1
```
