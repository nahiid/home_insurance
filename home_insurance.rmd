...
# Example usage with the "dataset_clean" dataframe
...
# Define mapping of total rate to salary ranges (you can customize this based on your specific needs)
salary_ranges <- cut(dataset_clean$Approx_Salary,
                     breaks = c(0, 12, 16, Inf),
                     labels = c("Low", "Medium", "High"))

# Add the salary range column to the dataframe
dataset_clean$Salary_Range <- salary_ranges
